...
function cssColorToArray(rgbString){
	if(rgbString.substr(0,1) != "#"){
		if( typeof namesToHex[rgbString.toLowerCase()] == 'undefined') {
			...
			return namesToHex[rgbString.toLowerCase()];
		}
	}
...
function rgbHexToCssColor(rgbHex){
	var a = rgbHexToArray(rgbHex);
	return rgbArrayCssColor(a);
}
...
function rgbArrayToHex(rgbArray){
	return rgbArray[0] * 0x10000 + rgbArray[1] * 0x100 + rgbArray[2];
}
